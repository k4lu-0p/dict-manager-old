 ...
 */
final class Version20190307133403 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE flat_rate (id INT AUTO_INCREMENT NOT NULL, customer_id_id INT NOT NULL, session_number INT NOT NULL, price DOUBLE PRECISION NOT NULL, date DATETIME NOT NULL, INDEX IDX_B7ADE9CDB171EB6C (customer_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, flat_rate_id_id INT DEFAULT NULL, date DATETIME NOT NULL, free TINYINT(1) NOT NULL, note VARCHAR(255) DEFAULT NULL, INDEX IDX_D044D5D42DEF342 (flat_rate_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE flat_rate ADD CONSTRAINT FK_B7ADE9CDB171EB6C FOREIGN KEY (customer_id_id) REFERENCES customer (id)');
        $this->addSql('ALTER TABLE session ADD CONSTRAINT FK_D044D5D42DEF342 FOREIGN KEY (flat_rate_id_id) REFERENCES flat_rate (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE session DROP FOREIGN KEY FK_D044D5D42DEF342');
        $this->addSql('ALTER TABLE flat_rate DROP FOREIGN KEY FK_B7ADE9CDB171EB6C');
