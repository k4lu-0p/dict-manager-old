 ...
 */
final class Version20190409123849 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE flat_rate CHANGE customer_id customer_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE session CHANGE flat_rate_id flat_rate_id INT DEFAULT NULL, CHANGE date_end date_end DATETIME DEFAULT NULL');
