 ...
 */
final class Version20190307141105 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE flat_rate (id INT AUTO_INCREMENT NOT NULL, customer_id INT NOT NULL, session_number INT NOT NULL, price DOUBLE PRECISION NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME DEFAULT NULL, INDEX IDX_B7ADE9CD9395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
