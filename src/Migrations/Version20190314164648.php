 ...
 */
final class Version20190314164648 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bill CHANGE customer_id customer_id INT DEFAULT NULL');
